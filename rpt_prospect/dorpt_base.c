...
{
	{ "PORT",		"",		INIT_STRING_LEFT },
	{ "TICKER",		"",		INIT_STRING_LEFT },
	{ "COMPANY",	"",		INIT_STRING_LEFT },
	{ "1YR GROW",	"",		INIT_DOUBLE_RIGHT },
	{ "5YR GROW",	"",		INIT_DOUBLE_RIGHT },
	{ "ENT VALUE",	"",		INIT_LONG_RIGHT },
	{ "RATIO",		"",		INIT_DOUBLE_RIGHT },
	{ "VAL OR P/E",	"",		INIT_STRING_CENTER },
...
#define		MAXTOKS		100
	...
	ReportOptions.Title = "PROSPECT REPORT";
	...
	sprintf ( ReportOptions.OutputFilename,  "%s/%s_%d", TEMPDIR, "prospect", getpid() );
