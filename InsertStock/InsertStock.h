...
// #define		DATAFILE		"/var/local/tmp/InsertStock.csv"
#define		DATAFILE		"/var/local/invest/symbols.txt"

#define		PRICEFILE		"/var/local/tmp/InsertStock.dat"

#define		MODE_CLOUD		1
#define		MODE_FILE		2
#define		MINIMUM_PRICE	5.0
TYPE	int		RunMode;
